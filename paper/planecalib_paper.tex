...
\begin{figure}
\centering
\includegraphics[width=0.32\linewidth]{images/synthCameraPosesRotation.pdf}
\includegraphics[width=0.32\linewidth]{images/synthCameraPosesTranslation.pdf}
\includegraphics[width=0.32\linewidth]{images/synthCameraPosesRandom.pdf}
...
\caption{Sample images used for calibration. Left: checkerboard captured with the PD1000 camera. Right: book cover captured with the Nexus camera.}
\end{figure}  
