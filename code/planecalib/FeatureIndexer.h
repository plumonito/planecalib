...
class IndexedCvKeypoint 
{
public:
	IndexedCvKeypoint() {}

	IndexedCvKeypoint(cv::KeyPoint *_keypoint, void *_descriptor):
		keypoint(_keypoint), descriptor(_descriptor)
	{}

	cv::KeyPoint *keypoint;
	void *descriptor;

	cv::Point2i getPosition() const {return keypoint->pt;}
	int getScore() const { return (int)keypoint->response; }
};
