...
public:
	...
	const Eigen::Matrix3f &getPose() const {return mPose;}
	Eigen::Matrix3f &getPose() { return mPose; }
	void setPose(const Eigen::Matrix3f &pose) { mPose = pose; }
