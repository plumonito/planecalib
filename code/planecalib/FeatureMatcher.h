...
public:
	...
	FeatureMatch(const FeatureMeasurement *source, int octave_, const Eigen::Vector2f &position_, int tracklength_) :
		mSourceMeasurement(source), mOctave(octave_), mPosition(position_), mTrackLength(tracklength_)
	{}
